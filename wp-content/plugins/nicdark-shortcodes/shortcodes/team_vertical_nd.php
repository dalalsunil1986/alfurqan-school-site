...
{  
  ...
  $icon1output = ( $atts['icon1'] != '' ) ? ' <a target="'.$a_target_iconlink1.'" title="'.$a_title_iconlink1.'" href="'.$a_href_iconlink1.'" class="nicdark_displaynone_ipadpotr nicdark_btn_icon nicdark_tooltip nicdark_bg_'.$atts['color'].' medium nicdark_shadow nicdark_radius_circle white nicdark_margin010"><i class="'.$atts['icon1'].' nicdark_rotate"></i></a> ' : '';
  $icon2output = ( $atts['icon2'] != '' ) ? ' <a target="'.$a_target_iconlink2.'" title="'.$a_title_iconlink2.'" href="'.$a_href_iconlink2.'" class="nicdark_displaynone_ipadpotr nicdark_btn_icon nicdark_tooltip nicdark_bg_'.$atts['color'].' medium nicdark_shadow nicdark_radius_circle white nicdark_margin010"><i class="'.$atts['icon2'].' nicdark_rotate"></i></a> ' : '';
  $icon3output = ( $atts['icon3'] != '' ) ? ' <a target="'.$a_target_iconlink3.'" title="'.$a_title_iconlink3.'" href="'.$a_href_iconlink3.'" class="nicdark_displaynone_ipadpotr nicdark_btn_icon nicdark_tooltip nicdark_bg_'.$atts['color'].' medium nicdark_shadow nicdark_radius_circle white nicdark_margin010"><i class="'.$atts['icon3'].' nicdark_rotate"></i></a> ' : '';
