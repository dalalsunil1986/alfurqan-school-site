   ...
   vc_map( array(
      ...
      "params" => array(
         ...
         array(
            ...
            "param_name" => "price",
            "description" => __( "Insert the price, example: 125 $", "nicdark-shortcodes" )
         ),
         array(
            "type" => "textfield",
            "class" => "",
            ...
            "description" => __( "Description under the price, example: MONTHLY", "nicdark-shortcodes" )
         ),
         array(
            'type' => 'attach_image',
         ...
         array(
            ...
            "param_name" => "text",
            "description" => __( "Insert your content, example: Lorem Ipsum Dolor&lt;hr/&gt;Lorem Ipsum Dolor&lt;hr/&gt;Lorem Ipsum Dolor&lt;hr/&gt;Lorem Ipsum Dolor", "nicdark-shortcodes" )
         ),
         array(
         'type' => 'vc_link',
          'heading' => "Link",
