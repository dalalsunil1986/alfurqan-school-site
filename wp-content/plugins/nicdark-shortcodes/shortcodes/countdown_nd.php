    ...
    (function($) { "use strict"; 
      ...
      $(".nicdark_countdown").countdown({
        ...
        render: function(data) {
          $(this.el).html("<div class=\"grid "+ grid +" "+ display_days +"  \"><div class=\"nicdark_textevidence center\"><h1 style=\"color:'.$atts['textcolor'].'\" class=\"subtitle white extrasize\">"+ this.leadingZeros(data.days, 3) +"</h1><div class=\"nicdark_space20\"></div><a class=\"nicdark_btn nicdark_bg_'.$atts['colord'].' small nicdark_shadow nicdark_radius white\">'.$nicdark_text_days.'</a><div class=\"nicdark_space5\"></div></div></div><div class=\"grid "+ grid +" "+ display_hours +"  \"><div class=\"nicdark_textevidence center\"><h1 style=\"color:'.$atts['textcolor'].'\" class=\"subtitle white extrasize\">"+ this.leadingZeros(data.hours, 2) +"</h1><div class=\"nicdark_space20\"></div><a class=\"nicdark_btn nicdark_bg_'.$atts['colorh'].' small nicdark_shadow nicdark_radius white\">'.$nicdark_text_hours.'</a><div class=\"nicdark_space5\"></div></div></div><div class=\"grid "+ grid +" "+ display_minutes +"  \"><div class=\"nicdark_textevidence center\"><h1 style=\"color:'.$atts['textcolor'].'\" class=\"subtitle white extrasize\">"+ this.leadingZeros(data.min, 2) +"</h1><div class=\"nicdark_space20\"></div><a class=\"nicdark_btn nicdark_bg_'.$atts['colorm'].' small nicdark_shadow nicdark_radius white\">'.$nicdark_text_minutes.'</a><div class=\"nicdark_space5\"></div></div></div><div class=\"grid "+ grid +" "+ display_seconds +"  \"><div class=\"nicdark_textevidence center\"><h1 style=\"color:'.$atts['textcolor'].'\" class=\"subtitle white extrasize\">"+ this.leadingZeros(data.sec, 2) +"</h1><div class=\"nicdark_space20\"></div><a class=\"nicdark_btn nicdark_bg_'.$atts['colors'].' small nicdark_shadow nicdark_radius white\">'.$nicdark_text_seconds.'</a><div class=\"nicdark_space5\"></div></div></div>");
        }
      });
