...
{	
   ...
   $str .= '<div class="'.$atts['class'].' nicdark_alerts nicdark_bg_'.$atts['bgcolor'].' '.$atts['class'].' nicdark_radius nicdark_shadow"><p class="white nicdark_size_medium"><i class="icon-cancel-circled-outline iconclose"></i>&nbsp;&nbsp;&nbsp;<strong>'.$atts['title'].':</strong>&nbsp;&nbsp;&nbsp;'.$atts['description'].'</p><i class="'.$atts['icon'].' nicdark_iconbg right medium '.$atts['bgcolor'].'"></i></div>';
