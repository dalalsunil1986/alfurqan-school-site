...
{  
  ...
  //if link
  $linkoutput = ( $a_href != '' ) ? ' <a target="'.$a_target.'" href="'.$a_href.'" class="white nicdark_btn"><i class="icon-graduation-cap-1"></i> '.$a_title.'</a> ' : '';
      
  //if icon1 icon2 icon3
  $icon1output = ( $atts['icon1'] != '' ) ? ' <a target="'.$a_target_iconlink1.'" title="'.$a_title_iconlink1.'" href="'.$a_href_iconlink1.'" class="nicdark_rotate nicdark_tooltip nicdark_btn_icon small nicdark_bg_'.$atts['color'].'dark nicdark_radius_circle white"><i class="'.$atts['icon1'].'"></i></a><div class="nicdark_space20"></div> ' : '';
  $icon2output = ( $atts['icon2'] != '' ) ? ' <a target="'.$a_target_iconlink2.'" title="'.$a_title_iconlink2.'" href="'.$a_href_iconlink2.'" class="nicdark_rotate nicdark_tooltip nicdark_btn_icon small nicdark_bg_'.$atts['color'].'dark nicdark_radius_circle white"><i class="'.$atts['icon2'].'"></i></a><div class="nicdark_space20"></div> ' : '';
  $icon3output = ( $atts['icon3'] != '' ) ? ' <a target="'.$a_target_iconlink3.'" title="'.$a_title_iconlink3.'" href="'.$a_href_iconlink3.'" class="nicdark_rotate nicdark_tooltip nicdark_btn_icon small nicdark_bg_'.$atts['color'].'dark nicdark_radius_circle white"><i class="'.$atts['icon3'].'"></i></a><div class="nicdark_space20"></div> ' : '';
  ...
  $str .= '
   ...
   <div class="'.$atts['class'].' nicdark_archive1 nicdark_bg_'.$atts['color'].' nicdark_radius nicdark_shadow">

        <div class="nicdark_textevidence nicdark_width_percentage40 nicdark_width100_responsive">
            <img alt="" class="nicdark_radius_left nicdark_opacity" src="'.$imgsrc[0].'">
        </div>
   ...
   vc_map( array(
      ...
      "params" => array(
         ...
         array(
          ...
          'param_name' => 'icons',
          'value' => array(
          __( 'Select', 'nicdark-shortcodes' ) => 'select',
