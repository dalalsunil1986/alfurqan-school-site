...
{  
   ...
   $str = '';
      ...
      //if link
      $linkoutput = ( $a_href != '' ) ? ' <a target="'.$a_target.'" href="'.$a_href.'" class="nicdark_press nicdark_btn nicdark_bg_'.$atts['color'].' medium nicdark_shadow nicdark_radius white">'.$a_title.'</a><div class="nicdark_space5"></div> ' : '';
      
      //icon style
      if ( $atts['cuticon'] == 1 ) { $iconoutput = '<a target="'.$a_target.'" href="'.$a_href.'" class="nicdark_btn_icon nicdark_bg_'.$atts['color'].' extrabig '.$atts['shape'].' white nicdark_shadow"><i class="'.$atts['icon'].'"></i></a>'; }else{ $iconoutput = '<div class="nicdark_btn_iconbg nicdark_bg_'.$atts['color'].' extrabig nicdark_shadow '.$atts['shape'].'"><div><i class="'.$atts['icon'].' nicdark_iconbg left big white"></i></div></div>'; }
      ...
      "params" => array(
         ...
         array(
             'type' => 'dropdown',
              'heading' => "Shape",
              'param_name' => 'shape',
              'value' => array( __( 'Select', 'js_composer' ) => 'select', __( 'Radius', 'js_composer' ) => 'nicdark_radius', __( 'Square', 'js_composer' ) => 'nicdark_square', __( 'Circle', 'js_composer' ) => 'nicdark_radius_circle' ),
