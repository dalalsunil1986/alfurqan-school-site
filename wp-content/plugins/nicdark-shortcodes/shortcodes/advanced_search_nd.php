   ...
   vc_map( array(
      ...
      "params" => array(
         ...
         'type' => 'dropdown',
          ...
          'admin_label' => true,
          'value' => array( "select", "courses", "excursions", "our-events" ),
         ...
         'type' => 'dropdown',
          'heading' => "Color Field",
          'param_name' => 'bginput',
          'value' => array( __( 'Select', 'nicdark-shortcodes' ) => 'select', __( 'Light Version', 'nicdark-shortcodes' ) => 'grey2', __( 'Dark Version', 'nicdark-shortcodes' ) => 'greydark2' ),
