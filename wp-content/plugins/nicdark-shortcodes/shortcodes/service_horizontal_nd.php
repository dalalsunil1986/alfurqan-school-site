...
{  
   ...
   $str = '';
      ...
      //if link
      $linkoutput = ( $a_href != '' ) ? ' <a target="'.$a_target.'" href="'.$a_href.'" class="nicdark_btn grey"><i class="icon-right-open-outline"></i> '.$a_title.'</a> ' : '';
      
      //icon style
      if ( $atts['cuticon'] == 1 ) { $iconoutput = '<a target="'.$a_target.'" href="'.$a_href.'" class="nicdark_btn_icon nicdark_bg_'.$atts['color'].' extrabig '.$atts['shape'].' white nicdark_absolute nicdark_shadow"><i class="'.$atts['icon'].'"></i></a>'; }else{ $iconoutput = '<div class="nicdark_btn_iconbg nicdark_bg_'.$atts['color'].' nicdark_absolute extrabig nicdark_shadow '.$atts['shape'].'"><div><i class="'.$atts['icon'].' nicdark_iconbg left big white"></i></div></div>'; }
