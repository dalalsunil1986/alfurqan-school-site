...
{  
   ...
   $str .= '
    ...
    <div class="'.$atts['class'].' nicdark_archive1 nicdark_bg_'.$atts['color'].' nicdark_bg_'.$atts['color'].'dark_hover nicdark_transition nicdark_radius nicdark_shadow">
        <div class="nicdark_margin20 nicdark_relative">  
            <a target="'.$a_target.'" href="'.$a_href.'" class="nicdark_displaynone_ipadpotr nicdark_btn_icon nicdark_bg_'.$atts['color'].'dark medium nicdark_radius_circle white nicdark_absolute nicdark_shadow"><i>'.$atts['number'].'</i></a>
