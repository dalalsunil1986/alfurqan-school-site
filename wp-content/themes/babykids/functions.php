...
function nicdark_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'source'             => 'http://www.nicdarkthemes.com/themes/baby-kids/wp/plugins/revslider_wp.zip', // The plugin source.
        ...
        array(
            ...
            'source'             => 'http://www.nicdarkthemes.com//themes/baby-kids/wp/plugins/contact-form-7_wp.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
        ),
        ...
        array(
            ...
            'source'             => 'http://www.nicdarkthemes.com/themes/baby-kids/wp/plugins/wordpress-importer_wp.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
        ),
        ...
        array(
            ...
            'source'             => 'http://www.nicdarkthemes.com/themes/baby-kids/wp/plugins/js_composer_wp.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
        ),
        ...
        array(
            ...
            'source'             => 'http://www.nicdarkthemes.com/themes/baby-kids/wp/plugins/nicdark-shortcodes_wp.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
        ),
        ...
        array(
            ...
            'source'             => 'http://www.nicdarkthemes.com/themes/baby-kids/wp/plugins/timetable_wp.zip', // The plugin source.
        ...
        array(
            ...
            'source'             => 'http://www.nicdarkthemes.com/themes/baby-kids/wp/plugins/woocommerce_wp.zip', // The plugin source.
            'required'           => false, // If false, the plugin is only 'recommended' instead of required.
            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
        ),
...
function nicdark_hide_taxonomy_inpost() {
  echo '<style> .post-type-post #typology-coursediv, .post-type-post #typology-eventdiv, .post-type-post #typology-excursiondiv { display:none; }</style>';
}
